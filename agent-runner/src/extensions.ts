...
// Discriminated union for MCP servers configured through Praktor. The agent
// runner adapts these entries to the active runtime SDK.
...
export async function applyExtensions(): Promise<ExtensionResult> {
  ...
  // MCP servers — return for merging into the agent runtime.
  if (ext.mcp_servers) {
